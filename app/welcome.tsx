...
const FeaturesSlide = React.memo(() => (
  <View style={styles.slide} className="px-8 justify-center">
    <View className="items-center mb-12">
      ...
      <Text className="mt-2 text-gray-400 dark:text-gray-500 font-medium">
    ...
    <View className="flex-row flex-wrap justify-between gap-4">
      {TILES.map((t, i) => (
        ...
        >
          ...
          <Text className="text-base font-black text-gray-900 dark:text-gray-100 mb-1">
            {t.label}
          </Text>
    ...
    <View style={styles.slide} className="px-10 justify-center">
      ...
      >
        ...
        <TextInput
          ...
          className={`text-xl text-gray-900 dark:text-gray-100 text-center ${
            isFocused
          ...
          >
            <Text
              className={`text-xl font-black tracking-wide ${
                !name.trim() ? "text-gray-300" : "text-white"
              }`}
            >
      ...
      >
        ...
        <View style={styles.footer}>
          ...
          {activeIndex < TOTAL_SLIDES - 1 && showNextButton && (
            <Animated.View
              style={{ opacity: nextButtonOpacity, width: "100%" }}
            >
              <Pressable
