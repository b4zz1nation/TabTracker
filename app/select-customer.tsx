      ...
      <View className="rounded-3xl mx-4 mb-3 bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 shadow-sm overflow-hidden">
        ...
        >
          ...
          <View className="flex-1">
            ...
            <Text className="text-xl font-black text-gray-900 dark:text-gray-100 tracking-tight">
              {item.name}
            </Text>
          </View>
          ...
          {stats.totalOngoing !== 0 && (
            <View className="items-end mr-2">
              <Text className="text-[8px] text-gray-400 dark:text-gray-500 uppercase tracking-widest font-black mb-0.5">
                Balance
              </Text>
              <Text
                className={`text-base font-black ${isPositive ? "text-emerald-500" : "text-gray-900 dark:text-gray-100"}`}
              >
                ₱{amountAbs}
              </Text>
            </View>
          ...
          >
            ...
            <View className="mb-8">
              ...
              <Text className="text-gray-500 dark:text-gray-400">
                This will also delete all their transaction history. This action
                cannot be undone.
              </Text>
            </View>
            ...
            <View className="gap-4">
              ...
              >
                <Text className="text-gray-400 dark:text-gray-500 font-semibold text-lg">
                  Cancel
                </Text>
              </Pressable>
            </View>
